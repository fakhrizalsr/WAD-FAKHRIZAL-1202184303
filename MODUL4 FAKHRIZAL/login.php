...
<body>
    ...
    <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.2); transition: 0.3s; border-radius: 5px; width: 30.5em; margin:0 auto; margin-top:25px">
        <div class="card-body">
            ...
            <form method="post" action="" class="p-2">
                ...
                <p class="text-center">Belum punya punya akun? <a href="register.php">Registrasi</a>
                    <p>
            </form>
        </div>
    </div>
